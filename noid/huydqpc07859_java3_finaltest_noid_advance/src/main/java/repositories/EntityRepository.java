...
public class EntityRepository {
    ...
    private String entity = "SINHVIEN";

    public EntityRepository(String nameTable) {
        entity = nameTable;
    }
    ...
    public List<Entity> fillter(String viTri) {
        Connection con = DatabaseUtil.getConnection();
        ResultSet rs = null;
        PreparedStatement pst = null;
        System.out.println("vi tri " + viTri);
      
        String sql = "SELECT * FROM " + entity + " WHERE VITRI = '" + viTri + "'";
    ...
    public Entity findById(String entityId) {
        ...
        ResultSet rs = null;
        PreparedStatement pst = null;
        String sql = "SELECT * FROM " + entity + " WHERE maNhanVien = ?";
        Entity entity = null;
    ...
    public boolean deleteEntity(String entityId) {
        Connection con = DatabaseUtil.getConnection();
        PreparedStatement pst = null;
        String sql = "DELETE FROM " + entity + " WHERE maNhanVien = ?";
        ...
        if (con != null) {
            try {
                ...
                for (Field field : fields) {
                    if (field.getName().equalsIgnoreCase("maNhanVien")) {
                        continue;
                    }
                ...
                pst.setString(parameterIndex, updatedEntity.getMaNhanVien());
