...
//    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (validateForm()) {
            if (repository.findById(this.txtId.getText()) != null) {
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        resetForm();
        choosing = false;
//        String chk = getSelectedCheckbox().stream().map(e -> e).collect(Collectors.joining(", "));
        System.out.println(getSelectedCheckbox());
        System.out.println(Arrays.asList(getSelectedCheckbox().split(", ")));
        System.out.println("Stringi".contains("String"));
...
//            txtName.requestFocus();
            ...
            if (validateForm()) {
                ...
                if (e.getUrl() == null) {
                    e.setUrl(repository.findById(this.txtId.getText()).getUrl());
                }
                disableAll();
